...
class EntityState(
     ...
     */
    constructor(
        id: String, attackAction: ActionType?, inspectAction: ActionType?, interactAction: ActionType?, inputAction: ((String, GameState) -> Unit)?
    ) : this(
        id, attackAction, inspectAction, interactAction, inputAction, Capabilities(
    ...
    /**
     * The action capabilities of the entity -- Can it be spoken to? Used to only show relevant actions to the user.
     *
