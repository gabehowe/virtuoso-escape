 ...
 * @author gabri
 */
data class FunString(val content: MutableList<Any>, val styleCodes: MutableList<String>, val resetCodes: MutableList<String>) {
     ...
     */
    constructor(funString: FunString) : this(
        funString.content.toMutableList(), funString.styleCodes, funString.resetCodes
    )
     ...
     * @param toReplace The [FunString] to replace the substring with.
     * @apiNote The behavior when [FunString]s collide is unknown.
     */
