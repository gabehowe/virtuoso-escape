...
public record AccountManager(JSONObject accounts, JSONObject gameStates) {
     ...
     * @return the {@code Optional<Account>} if username-password combination was valid, otherwise
     *     {@code Optional.empty}.
     */
     ...
     * @param username The username to attempt.
     * @param password The password to attempt.
     * @return the {@code Optional<Account>} if no user exists with this exact username-password combination, otherwise
     *     {@code Optional.empty}.
     */
            ...
            if (value instanceof JSONObject acct) {
                ...
                if (uName.equals(username) && (pWord.equals(hashedPassword))) {
                    if (highScore instanceof JSONObject score) {
                        ...
                        Duration timeRemaining = score.get("timeRemaining") == null
                                ? null
                                : Duration.ofSeconds((Long) score.get("timeRemaining"));
