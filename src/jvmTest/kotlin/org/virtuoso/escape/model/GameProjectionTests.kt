...
class GameProjectionTests {
    ...
    fun testCreateAccountNewUserFailsDueToBug() {
        ...
        // Implementation Bug: newAccount returns new Account, but AccountManager is immutable/not updated. 
        // GameProjection expects it in map -> NPE.
        
        assertFailsWith<NullPointerException> {
            proj.createAccount("newUser", "newPass")
        }
    }
    ...
    fun testDelegatedProperties() {
        ...
        // Room change
        val room = proj.currentFloor().rooms.last() // Use last to ensure it's different if possible, or just checking setter
        proj.pickRoom(room)
