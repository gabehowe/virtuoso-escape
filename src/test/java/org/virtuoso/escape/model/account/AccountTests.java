...
class AccountTests {
    ...
    @DisplayName(
            "Should throw an IllegalArgumentException on attempt to create account with null username and password")
    @Test
    ...
    void testValidSecondConstructor() {
        Account mrsDummy = new Account(
                "mrsdummy", "mrsdummy", UUID.randomUUID(), new Score(null, Difficulty.SUBSTANTIAL, null), false);
